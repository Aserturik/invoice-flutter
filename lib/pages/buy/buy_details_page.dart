...
@RoutePage()
class BuyDetailsPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BuyDetailsPage> createState() => _HomePageState();
}

class _HomePageState extends ConsumerState<BuyDetailsPage> {
  @override
